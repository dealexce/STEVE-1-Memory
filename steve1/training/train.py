    ...
    with th.no_grad():
        for obs, actions, firsts in val_dataloader:
            ...
            for t in range(0, T, args.trunc_t):
                ...
                # NOTE: somehow, the large chunk is divided into smaller chunks here to input the policy
                # originally is [batch_size=4, chunk_size=300, *attr.shape], 
                # now is [batch_size=4, (mini)_chunk_size=10, *attr.shape]
